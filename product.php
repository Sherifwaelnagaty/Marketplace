            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">$<?php echo $row[3];?></div>
                        <a href="shopping-cart.php?id=<?php echo $row['productID'];?>" class="primary-btn">ADD TO CARD</a>
                        <br>
                        <?php if(!isset($_SESSION["Email"])){
                                }else{
                                    if($_SESSION["Types"]=="Admin"){
                                echo'<a href="edit_product.php?id='.$row[0].'"class="primary-btn">Edit Product</a>';
                                echo'<a href="Delete_product.php?id='.$row[0].'" class="primary-btn">Delete Product</a>';
                                    }
                                }
                            }
                        ?>
